...
export function Hero() {
  return (
    <section className="min-h-[100dvh] flex flex-col justify-center px-6 md:px-12 relative overflow-hidden bg-white" id="inicio">
      ...
      <div className="absolute inset-0 flex items-center justify-center z-20 parallax-medium pointer-events-none">
      ...
      {/* Layer 3: "REQUENA" text - front layer */}
      <div className="absolute inset-x-0 bottom-28 md:bottom-12 flex items-end justify-end z-30 parallax-fast pointer-events-none">
